...
public class PointMatch
{
	...
	/**
	 * convert from Matches, weight is 1.0
	 * 
	 * @param matches
	 * @return
	 */
	final public static ArrayList< PointMatch > fromMatches( Collection< Match > matches )
	{
	...
	/**
	 * convert to Matches using the world coordinates, weight gets lost
	 * 
	 * @param matches
	 * @return
	 */
	final public static ArrayList< Match > toMatches( Collection< PointMatch > matches )
	{
	...
	final public static ArrayList< Match > toLocalMatches( Collection< PointMatch > matches )
	{
		ArrayList< Match > list = new ArrayList< Match >();
		for ( PointMatch match : matches )
		{
