...
TrakEM2_.jar <- ini/trakem2/*java ini/trakem2/analysis/*java ini/trakem2/display/*.java ini/trakem2/display/graphics/*java ini/trakem2/imaging/*.java ini/trakem2/io/*java ini/trakem2/parallel/*java ini/trakem2/persistence/*java ini/trakem2/plugin/*java ini/trakem2/scripting/*java ini/trakem2/tree/*java ini/trakem2/utils/*java mpi/*/*/*.java mpi/*/*/*/*.java mpicbg/*/*/*.java lenscorrection/*.java img/*.png plugins.config bunwarpj/trakem2/transform/*.java
